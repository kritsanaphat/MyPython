...
def check_binary_search_tree_(root,check=[]):
    ...
    if root.left is None and root.right is None:
        ...
        if root.right.data > root.data:
            return check_binary_search_tree_(root.right,check) 
        else:
            return False
    elif root.right is None:
        if root.left.data < root.data:
            return check_binary_search_tree_(root.left,check)
        else:
            return False
    else:
        if root.right.data > root.data and root.left.data < root.data:
            return check_binary_search_tree_(root.right,check) and check_binary_search_tree_(root.left,check)
        else:
            return False
